...
const CS_HREDRAW:u32=2; const CS_VREDRAW:u32=1; const IDC_ARROW:*const u16=32512usize as *const u16; const WS_OVERLAPPEDWINDOW:u32=0x00CF0000; const WS_VISIBLE:u32=0x10000000; const CW_USEDEFAULT:i32=i32::MIN; const SW_SHOW:i32=5; const SRCCOPY:u32=0x00CC0020; const BLACKNESS:u32=0x00000042; const DIB_RGB_COLORS:u32=0; const BI_RGB:u32=0; const HALFTONE:i32=4; const WA_INACTIVE:usize=0;
